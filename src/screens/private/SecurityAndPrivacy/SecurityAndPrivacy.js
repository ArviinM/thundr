    ...
    <ScrollView
      ...
      <View style={{alignItems: 'center', paddingHorizontal: scale(20)}}>
        ...
        <Text fontFamily="Montserrat-Regular" color="#808080">
          ...
          protect our legal rights, and to enforce our Terms & Conditions.{'\n'}
          ...
          and/or blocked. Affected Users can contact Tanders Inc. to contest the
          decision.{'\n\n'}
          ...
          {'\n'}• IT services – some of the third-party software providers used
          in the operation of our business may process Users’ personal data (for
          example, if a User contacts us via social media with a support
          inquiry, their inquiry is processed by our community management
          software provider){'\n\n'}We carry out due diligence on all Service
          Providers we engage to ensure they have adequate data protection and
          information security measures in place and only provide them with the
          personal data necessary to the service they are providing. Measures
          are taken to ensure that the data shared is non-attributable to the
          greatest extent possible and our suppliers are also subject to
          extensive obligations under our contractual arrangements, including
          ...
          App and action taken on those (for example if you downloaded our App,
          ...
          share the password you use to access your Thundr Account with anyone
          else! If you ever think someone has had access to your password or
          Account, please let us know by emailing us at hello@thundr.ph.{'\n\n'}
